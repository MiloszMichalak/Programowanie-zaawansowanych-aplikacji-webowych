...
async function bazaKsiazki() {
    ...
    const [rows] = await pool.execute('SELECT au.imie, au.nazwisko, ks.tytul, ks.cena FROM ksiazki as ks, autorzy as au where au.IDautor=ks.autor ORDER BY au.nazwisko');
    console.log('Query Results:', rows)
    return rows;
}
