...
function getProperValue(name, lista){
  switch (name) {
    case "szescian":
      return changeValueToList(obliczPoleSzescianu(lista[0].wymiar), obliczObjetoscSzescianu(lista[0].wymiar));
    case "prostopadloscian":
      return changeValueToList(obliczPoleProstopadloscianu(lista[0].wymiar, lista[1].wymiar, lista[2].wymiar), obliczObjetoscProstopadloscianu(lista[0].wymiar, lista[1].wymiar, lista[2].wymiar));
    case "kula":
      return changeValueToList(obliczPoleKuli(lista[0].wymiar), obliczObjetoscKuli(lista[0].wymiar));
    default:
      return "error";
  }
}
              ...
              <tr key={item.id}>
                ...
                <td>
                  <ol>
                    ...
                    <p className='values'>
                    Pole: {getProperValue(item.nazwa, item.wymiary)[0].pole} <br></br> 
                    Objetosc: {getProperValue(item.nazwa, item.wymiary)[0].objetosc}</p>
                  </ol>
                </td>
              </tr>
            ))
