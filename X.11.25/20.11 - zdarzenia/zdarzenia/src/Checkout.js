    ...
    return (
        <Container>
            <form>
                ...
                <br/>
                Wprowadzone imię: {(daneOsobowe.imie==="") ? "jeszcze nie wprowadzone" : daneOsobowe.imie}
                <br/>
                Wprowadzone nazwisko: {(daneOsobowe.nazwisko==="") ? "jeszcze nie wprowadzone" : daneOsobowe.nazwisko}
            </form>
        </Container>
    );
}
